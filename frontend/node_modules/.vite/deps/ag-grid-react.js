...
var HeaderFilterCellComp = ({ ctrl }) => {
  ...
  const setRef2 = (0, import_react15.useCallback)((eRef) => {
    ...
    const compProxy = {
      ...
      setMenuIcon: (eIcon) => {
        var _a3;
        return (_a3 = eButtonShowMainFilter.current) == null ? void 0 : _a3.appendChild(eIcon);
      }
    };
  ...
  const floatingFilterProps = (_a2 = floatingFilterCompProxy.current) == null ? void 0 : _a2.getProps();
  const reactUserComp = userCompDetails == null ? void 0 : userCompDetails.componentFromFramework;
  const UserCompClass = userCompDetails == null ? void 0 : userCompDetails.componentClass;
